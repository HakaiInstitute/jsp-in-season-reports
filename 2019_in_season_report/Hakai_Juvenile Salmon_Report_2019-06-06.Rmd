...
#TODO REMOVE end of season from time series for comparison of this years results only
...
```{r Lice Prevalence, fig.cap= "The proportion of juvenile chum, pink and sockeye that had at least one motile sea louse of either _Lepeoptheirus salmonis_ and _Caligus clemensi_ in the Discovery Islands (DI) and Johnstone Strait (JS) in 2019. Instances of zero prevalence are labelled as such."}
...
```{r Motile Caligus and Lep abundance on chum. pink, and sockeye , fig.cap = "The abundance  ± SE of __motile__ _Lepeoptheirus salmonis_ and _Caligus clemensi_ sea lice combined infecting juvenile chum, pink and sockeye salmon in the Discovery Islands and Johnstone Strait in 2019."}
...
```{r Lice cal intensity, echo = FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = "The mean infection intensity ± SE of __motile__ _Lepeoptheirus salmonis_ and _Caligus clemensi_ sea lice per juvenile salmon infected with one or more motile _Lepeoptheirus salmonis_ and _Caligus clemensi_ louse in 2019."}
