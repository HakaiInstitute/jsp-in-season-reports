...
```{r species_proportion, fig.cap = "Proportion of juvenile salmon caught in the Discovery Islands in the sampling weeks of May 19, May 26, June 2, and June 9, from 2015-2021." }
species_prop_2015_2020 <- ss_GH %>%
  filter(region == "DI")  %>%
  filter(sampling_week == c("May 19", "May 26", "June 2", "June ")) %>%
  rename("Sockeye" = "so_total",
         "Pink" = "pi_total",
         "Chum" = "cu_total",
         "Coho" = "co_total", 
