...
To provide a seasonal summary of juvenile salmon migration characteristics and oceanographic conditions in the northern Strait of Georgia region in British Columbia, Canada. 
...
2) Discovery Islands – highly-mixed low-plankton-biomass zone, and area of high potential for wild-farmed fish interactions.
...
Please direct questions or comments to Brian Hunt (B.Hunt@oceans.ubc.ca), Tim van der Stap (Tim.vanderstap@hakai.org), Krystal Bachen (Krystal.Bachen@hakai.org), Natalie Benoit (n.benoit@oceans.ubc.ca) and/or Brett Johnson (Brett.Johnson@hakai.org). 

The Hakai Institute embraces an "Open Science Policy"; to that end you can access the data used in this report at https://github.com/HakaiInstitute/jsp-data.
...
```{r rolling mean ts v current, fig.cap = "Sockeye catches (bars) and rolling seven day average (lines) in 2021 compared catches averaged by day across all years"}
...
```{r interannual lice comparison, fig.cap= "The proportion of juvenile chum, pink, and sockeye infected with at least one sea-louse of either _Lepeophtheirus salmonis_ and _Caligus clemensi_, in the three sampling zones within the Discovery Islands, in 2021."}
