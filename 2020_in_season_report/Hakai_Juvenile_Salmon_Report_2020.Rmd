...
fish_lice_field_stacked_plot <- ggplot(fish_lice_2020, aes(x = sampling_week, y = prop, fill = lice_presence))+
  ...
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12,face="bold")) +
  scale_fill_discrete(name = "Sea-louse occurrence", labels = c("absent", "present"))+
  xlab("Sampling week")+
...
* The first sockeye recorded in the Discovery Islands was May 19th -- several days earlier than in 2018 and 2019, but later than in 2015 and 2016.
* The majority of sockeye caught were infected with at least one sea-louse.
* Spring ocean temperatures are colder than the average over the past five years. 
