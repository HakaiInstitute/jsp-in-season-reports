...
qu39_temp_anomaly_data <-
  ...
  add_row(
    station = "QU39",
    yday = (39 + 49) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (39 + 49) / 2),
    mean_temp = predict(temp.lo_qu39, (39 + 49) / 2)
  ) %>%
  add_row(
    station = "QU39",
    yday = (62 + 67) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (62 + 67) / 2),
    mean_temp = predict(temp.lo_qu39, (62 + 67) / 2)
  ) %>%
  add_row(
    station = "QU39",
    yday = (67 + 74) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (67 + 74) / 2),
    mean_temp = predict(temp.lo_qu39, (67 + 74) / 2)
  ) %>%
  add_row(
    station = "QU39",
    yday = (74 + 83) / 2,
    predicted_mean_temp = predict(temp.lo_qu39, (74 + 83) / 2),
    mean_temp = predict(temp.lo_qu39, (74 + 83) / 2) 
  ) %>% 
  add_row(
    station = "QU39",
    yday = (151 + 158) / 2,
