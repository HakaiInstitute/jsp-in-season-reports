...
```{r abundance plot, fig.cap= "The mean abundance of sea lice in the Discovery Islands, BC.",fig.dim=c(8, 8)}
...
```{r prevalence plot, fig.cap = "The mean prevalence of sea lice in the Discovery Islands, BC. ", fig.dim=c(7, 7)}
...
## Highlights
 * In 2022 we observed the lowest catch intensity of sockeye salmon in our time series. The date of first sockeye capture was the latest in the time series, though low abundance of sockeye likely affected catchability and our estimate of migration timing.
